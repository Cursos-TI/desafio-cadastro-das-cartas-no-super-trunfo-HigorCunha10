...
int main() {
    ...
    printf ("quem vence em população? %d\n", populacao1 > populacao2);
    printf ("quem vence em area em km2? %d\n", areaemkm21 > areaemkm22);
    printf ("quem tem o maior pib? %df\n", pib1 > pib2);
    printf ("quem tem a maior quantiade pontos turisticos? %d\n", pontosturisticos1 > pontosturisticos2);
    printf ("Quem tem a maior densidade populacional?%d\n", densidade1 > densidade2);
    printf ("quem tem maior pib percapta?%d\n", percapta1 > percapta2);
    printf ("quem tem o maoir super poder?%d\n", superpoder1 > superpoder2);
